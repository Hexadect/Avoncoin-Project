...
unsigned int nStakeMaxAge = 365 * 60 * 24 * 30 ;  // one year
...
const string strMessageMagic = "avoncoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
	...
	{
		nSubsidy = 1000000000 * COIN;	// 1000 millions coins, that all pow coins
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    nRewardCoinYear = MAX_MINT_PROOF_OF_STAKE;
	     ...
	     if(pindexBest->nHeight <  1 * YEARLY_BLOCKCOUNT)
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "avoncoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Avoncoin.com builds AVONCOIN 01 Jan 2017";
        CTransaction txNew;
        txNew.nTime = 1445766337;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1484043656;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1682682;
		if(fTestNet)
        {
            block.nTime    = 1484043656;
            block.nNonce   = 1682682;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x5932410f9200448cf3bf3fd79d3bfc1f2686e06b528cadcba684483f78e942f0"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xff, 0xef, 0xeb, 0xf1 };
